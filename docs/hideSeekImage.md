...
layout: default
title: Hide N Seek
permalink: /hideSeekImage/
---

<img src="{{ '/assets/images/hideSeekImage.jpeg' | relative_url }}" alt="banner" class="banner">
<a href="{{ '/tryme' | relative_url }}" class="btn btn-primary">Back to Try Me!</a>

# Hide N Seek by Images


<div>Show or hide yourself</div>
...
<script type="text/javascript">
    ...
    const URL = '/assets/models/hideSeekImage/';
